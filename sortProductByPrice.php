...
if(isset($_POST['sortProductByPrice'])){
	$price = $_POST['price'];
	if($price == 'Low to high'){
		$fetchAllData = $db->query("SELECT * FROM allproducts ORDER BY sellingPrice");
	...
	<?php
		...
		$fetchAllData = $db->query("SELECT * FROM allproducts ORDER BY sellingPrice DESC");
		while($allDataRow = $fetchAllData->fetch_assoc()){
	?>
		<div class="col-md-4 col-xs-12 item-container">
			<div class="productItem">
